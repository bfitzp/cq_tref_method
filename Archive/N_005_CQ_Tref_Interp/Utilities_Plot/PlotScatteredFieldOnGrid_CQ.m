...
c_adapt = testFreqResults{1};
nrmlz_adapt = testFreqResults{2}.';
Z_adapt = testFreqResults{3};
pol_adapt = testFreqResults{4};
scl_adapt = testFreqResults{5};
n_adapt = testFreqResults{6};
d_adapt = testFreqResults{7};
...
u_s_testFreq = zeros(size(zz(:),1),1);
...
%         tic
%         for j=1:50
%             u_s(:,l+1) = u_s_testFreq_(zz,c_adapt,nrmlz_adapt,k_l);
%         end
%         toc
% %         else
%         tic
